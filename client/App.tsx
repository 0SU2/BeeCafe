...
const ingresarNombre = (text) => {
  setNombre(text);
}

const ingresarAPaterno = (text) => {
  setAPaterno(text);
}

const ingresarAMaterno = (text) => {
  setAMaterno(text);
}

const ingresarCorreo = (text) => {
  setCorreo(text);
}

const ingresarContrasena = (text) => {
  setContrasena(text);
}

const ingresoConfirmarContrasena = (text) => {
